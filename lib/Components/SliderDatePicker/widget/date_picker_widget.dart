...
class DatePickerWidget extends StatefulWidget {
  DatePickerWidget({
    ...
    this.onConfirm,
    this.looping: false,
    this.datePickerWidgetController
  }) : super(key: key) {
  ...
  DatePickerWidgetController datePickerWidgetController;
...
class DatePickerWidgetController {
   _DatePickerWidgetState _state;

   DateTime getCurrentDateTime() {
     return DateTime(_state._currYear, _state._currMonth, _state._currDay);
   }
