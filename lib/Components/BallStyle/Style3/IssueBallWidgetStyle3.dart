...
import 'IssueBallWidgetStyle3ViewModel.dart';
...
class IssueBallWidgetStyle3 extends StatelessWidget
    ...
    return ChangeNotifierProvider(
        ...
        create: (_) => IssueBallWidgetStyle3ViewModel(
              ...
              issueBallBasicStyle: IssueBallBasicStyleImpl(
                  context: context, fireBaseAuthAdapterForUseCase: sl()),
            ),
  ...
  Container makerInfoBar(
    ...
    return Container(
      ...
      child: RichText(
        text: TextSpan(
            text: model.issueBall.uid.nickName,
            ...
            children: <TextSpan>[
              TextSpan(text: "    "),
              TextSpan(
                  text: "${model.issueBall.uid.userLevel.toStringAsFixed(0)}  lv",
                  style: GoogleFonts.notoSans(
                    fontWeight: FontWeight.w700,
                    fontSize: 9,
