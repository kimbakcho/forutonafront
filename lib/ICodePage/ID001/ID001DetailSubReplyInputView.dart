...
import 'ID001DetailSubReplyInputViewModel.dart';

class ID001DetailSubReplyInputView extends StatelessWidget {
  final FBallSubReplyResDto mainReply;

  ID001DetailSubReplyInputView(this.mainReply);

  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
        create: (_) => ID001DetailSubReplyInputViewModel(mainReply,context),
        child: Consumer<ID001DetailSubReplyInputViewModel>(
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        Container(
                          ...
                          child: Row(children: <Widget>[
                            ...
                            Container(
                              ...
                              child: FlatButton(
                                ...
                                child: Icon(ForutonaIcon.replysendicon,color: Colors.white,size: 16,),
                              ),
                              decoration: BoxDecoration(
                                  shape: BoxShape.circle,
                          ...
                          decoration:
                          BoxDecoration(color: Color(0xffF2F0F1)),
                        )
                      ],
                    )
                  )
