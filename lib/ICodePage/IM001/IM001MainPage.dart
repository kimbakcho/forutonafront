...
class _IM001MainPageState extends State<IM001MainPage> with WidgetsBindingObserver {
    AppLifecycleState _lastLifecycleState;
   LatLng setUpPosition;
   String address;
   String ballUuid;
   IM001MainPageEnterMode mode;
   IM001MainPageViewModel childModel;
    ...
    return model.ballImageList.length != 0
      ...
      child: Stack(children: <Widget>[
        ...
        Positioned(
            ...
            left: 0,
            child: Container(
                height: 68, width: MediaQuery.of(context).size.width, child: imageListView(model)))
      ]),
      decoration: BoxDecoration(
          border: Border(
