...
class CodeCountry {
  ...
  String findCountryName(String isoCode){
    var country = codes.firstWhere((x){
      return x['code'] == isoCode.toUpperCase();
    });
    return country['name'];
  }

  List<CountryItem> countryList(){
    return codes.map((x) => new CountryItem(x['name'],x['code'],x['dial_code'])).toList();
  }
