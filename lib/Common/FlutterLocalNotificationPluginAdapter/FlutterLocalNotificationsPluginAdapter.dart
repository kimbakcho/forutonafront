...
final StreamController<String> selectNotificationSubjectStreamController =
    StreamController();

final Stream<String> selectNotificationSubject =
    selectNotificationSubjectStreamController.stream;
...
class FlutterLocalNotificationsPluginAdapterImpl
  ...
  Future<String> downloadAndSaveFile(String url, String fileName) async {
    ...
    var dio = new Dio();
    var rs = await dio.get<List<int>>(url,
