...
class FcubeExtenderMarkerGenerator {
  final Function(List<Uint8List>) callback;
  final List<FcubeExtender1> markerWidgets;

  FcubeExtenderMarkerGenerator(this.markerWidgets, this.callback);
