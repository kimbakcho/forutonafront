                      ...
                      child: FlatButton(
                          ...
                          onPressed: () async {
                            GlobalStateContainer.of(context).state.isnewuser =
                                true;
                            int result =
                                await UserInfoMain.insertUserInfo(userinfomain);
                            if (result > 0) {
                                ...
                                child: TextField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      hintStyle: TextStyle(
                                        ...
                                        fontSize: 15,
                                        color:
                                            Color(0xff78849e).withOpacity(0.56),
                                      ),
                ...
                Positioned(
                    ...
                    child: Container(
                        decoration: BoxDecoration(
                            color: Colors.white,
                            border:
                                Border.all(color: Color(0xff78849E), width: 1),
                            image: DecorationImage(
                        ...
                        child: FlatButton(
                            ...
                            onPressed: () async {
                              ...
                              userinfomain.profilepicktureurl =
                                  profileimagelink;
                              userimage =
                                  NetworkImage(userinfomain.profilepicktureurl);
                              setState(() {});
                            })))
              ],
            ),
