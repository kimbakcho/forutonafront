        ...
        child: Container(
          child: AnimatedContainer(
            ...
            margin: EdgeInsets.only(
                top: context
                    .watch<H001ViewModel>()
                    .makeButtonDisplayShowFlag ? 0 : 120),
          ),
          height: 120,
              ...
              itemBuilder: (builder, index) {
                return Container(
                    ...
                    child: FlatButton(
                        ...
                        onPressed: () {
                          context.read<H001ViewModel>().gotoTagSearch(context
                              .read<H001ViewModel>()
                              .tagRankingDtos[index].tagName);
                        },
                        child: Row(children: <Widget>[
                          Text("${context
                              .watch<H001ViewModel>()
                              .tagRankingDtos[index].ranking}.",
                    ...
                    child: Row(children: <Widget>[
                      ...
                      Container(
                        ...
                        child: FlatButton(
                            padding: EdgeInsets.all(0),
                            onPressed: () {
                              context.read<H001ViewModel>()
                                  .showUnInlineRankingWidget();
                            },
