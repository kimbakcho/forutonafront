...
class TermsTextLink extends StatelessWidget {
  ...
  TermsTextLink({Key key,@required this.label,@required this.idx,@required this.linkTitle}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => TermsTextLinkViewModel(this.linkTitle,this.idx,sl()),
      child: Consumer<TermsTextLinkViewModel>(
...
class TermsTextLinkViewModel extends ChangeNotifier {
  ...
  TermsTextLinkViewModel(this.linkTitle, this.idx, this.termsConditionsUseCaseInputPort);
