                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: PwInputAndCheckComponent(
                            pwInputAndCheckComponentController: model._pwInputAndCheckComponentController,
                          ),
                        )
                      ])));
        }));
...
class L007MainPageViewModel extends ChangeNotifier {
  ...
  L007MainPageViewModel(this._fUserInfoJoinReq) {
  ...
  onCheckWithNextPage(BuildContext context) async {
    ...
    if(emailCheck && pwCheck){
      _fUserInfoJoinReq.email = _emailCheckComponentController.emailValue;
      _fUserInfoJoinReq.password = _pwInputAndCheckComponentController.getPwValue();
  ...
  get _nextButtonSatisfied {
    return currentEmailValue.isNotEmpty && currentPwValue.isNotEmpty && currentPwCheckValue.isNotEmpty;
  }
}
