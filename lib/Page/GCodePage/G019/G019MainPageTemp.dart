...
class G019MainPageTemp extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
        create: (_) => G019MainPageTempViewModel(context),
        child: Consumer<G019MainPageTempViewModel>(builder: (_, model, child) {
  ...
  Container companyIntroductionBar(G019MainPageTempViewModel model,BuildContext context) {
    return Container(
        height: 48.00,
  ...
  Column policyColumn(G019MainPageTempViewModel model,BuildContext context) {
    return Column(
      children: <Widget>[
  ...
  Container openSourceProtectionPolicyBtnBar(G019MainPageTempViewModel model,BuildContext context) {
    return Container(
        height: 48.00,
        width: MediaQuery.of(context).size.width,
        child: FlatButton(
  ...
  Container positionInformationProtectionPolicyBtnBar(
      G019MainPageTempViewModel model,BuildContext context) {
    return Container(
        height: 48.00,
        width: MediaQuery.of(context).size.width,
        child: FlatButton(
  ...
  Container forutonaUseAgreementBtnBar(G019MainPageTempViewModel model,BuildContext context) {
    return Container(
        height: 48.00,
        width: MediaQuery.of(context).size.width,
        child: FlatButton(
  ...
  topBar(G019MainPageTempViewModel model, BuildContext context) {
    return Container(
      height: 56,
      width: MediaQuery.of(context).size.width,
      color: Colors.white,
