...
import 'G012MainPageTempViewModel.dart';

// ignore: must_be_immutable
class G012MainPageTemp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(create: (_) {
      ...
      return G012MainPageTempViewModel(
          context: context,
    ...
    }, child: Consumer<G012MainPageTempViewModel>(builder: (_, model, child) {
  ...
  Container checkPwErrorBar(G012MainPageTempViewModel model) {
    return Container(
  ...
  Container checkPwTextField(G012MainPageTempViewModel model) {
    return Container(
        height: 49.00,
  ...
  Container newPwTextField(G012MainPageTempViewModel model) {
    return Container(
        height: 49.00,
        margin: EdgeInsets.fromLTRB(16, 0, 16, 0),
        child: TextField(
  ...
  Container newPwErrorBar(G012MainPageTempViewModel model) {
    return Container(
      margin: EdgeInsets.fromLTRB(32, 8, 16, 8),
  ...
  Container currentPwErrorBar(G012MainPageTempViewModel model) {
    return Container(
      margin: EdgeInsets.fromLTRB(32, 8, 16, 8),
  ...
  Container currentPwTextField(G012MainPageTempViewModel model) {
    return Container(
        height: 49.00,
  ...
  Container topBar(G012MainPageTempViewModel model) {
    return Container(
      height: 56,
      color: Colors.white,
      child: Row(children: [
