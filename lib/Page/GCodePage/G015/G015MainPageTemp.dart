...
import 'package:forutonafront/Page/GCodePage/G015/G015MainPageTempViewModel.dart';
import 'package:provider/provider.dart';

class G015MainPageTemp extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
        create: (_) => G015MainPageTempViewModel(context),
        child: Consumer<G015MainPageTempViewModel>(builder: (_, model, child) {
  ...
  Container sponsorNewContentSettingBar(G015MainPageTempViewModel model) {
    return Container(
        height: 65,
  ...
  Container followNewContentSettingBar(G015MainPageTempViewModel model) {
    return Container(
        height: 64,
  ...
  Container myReplyReplyAlarmSettingBar(G015MainPageTempViewModel model) {
    return Container(
        height: 48,
  ...
  Container myContentReplyAlarmSettingBar(G015MainPageTempViewModel model) {
    return Container(
        height: 48,
  ...
  Container chatAlarmSettingBar(G015MainPageTempViewModel model) {
    return Container(
        height: 48,
  ...
  Container topBar(G015MainPageTempViewModel model) {
    return Container(
