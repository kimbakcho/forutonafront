...
class BasicReViewsInsert extends StatelessWidget {
  ...
  const BasicReViewsInsert(
      {Key key, this.ballUuid, this.rootReplyUuid,ReviewInertMediator reviewInertMediator})
      : _reviewInertMediator = reviewInertMediator,super(key: key);
        ...
        child: Consumer<ID001ReplyInsertViewModel>(builder: (_, model, __) {
          return Container(
              padding: MediaQuery.of(context)
                  .viewInsets
                  .add(EdgeInsets.fromLTRB(16, 8, 16, 8)),
