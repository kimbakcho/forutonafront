...
abstract class IIssueBallTypeRemoteDateSource {
...
class IssueBallTypeRemoteDateSource implements IIssueBallTypeRemoteDateSource{

  IssueBallTypeRemoteDateSource();
