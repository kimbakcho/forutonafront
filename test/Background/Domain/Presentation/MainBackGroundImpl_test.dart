...
void main() {
  ...
  test('should config with Loop 메소드 등록', () async {
    //arrange
    when(mockBackgroundFetchAdapter.configWithLoopFuncRegister(any));
    //act
  ...
  test('should UserPositionUseCaseInputPort Loop 실행', () async {
   ...
   verifyInOrder([
    ...
    verify(mockBackgroundFetchAdapter.backgroundFetchFinish('com.wing.forutonafront.UserPositionService'))
   ]);
